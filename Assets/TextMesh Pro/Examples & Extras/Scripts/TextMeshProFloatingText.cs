...
namespace TMPro.Examples
{
    ...
    public class TextMeshProFloatingText : MonoBehaviour
    {
        ...
        public IEnumerator DisplayTextMeshProFloatingText()
        {
            ...
            float currentLevelData_Count = starting_Count;
            ...
            while (currentLevelData_Count > 0)
            {
                currentLevelData_Count -= (Time.deltaTime / CountDuration) * starting_Count;

                if (currentLevelData_Count <= 3)
                {
                    //Debug.Log("Fading Counter ... " + currentLevelData_Count.ToString("f2"));
                    alpha = Mathf.Clamp(alpha - (Time.deltaTime / fadeDuration) * 255, 0, 255);
                }

                int_counter = (int)currentLevelData_Count;
                m_textMeshPro.text = int_counter.ToString();
                //m_textMeshPro.SetText("{0}", (int)currentLevelData_Count);
        ...
        public IEnumerator DisplayTextMeshFloatingText()
        {
            ...
            while (currentLevelData_Count > 0)
            {
                ...
                //Debug.Log("currentLevelData Count:" + currentLevelData_Count.ToString("f2"));
